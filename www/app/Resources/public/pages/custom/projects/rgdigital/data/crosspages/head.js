    ...
    blocks: [
        ...
        },
		{
            ...
            opt: {
                ...
                attrs: {
                    rel: "stylesheet",
                    href: "/res/styles/custom/projects/rgdigital/lib.css"
                }
            }
        },
        {
            ...
            opt: {
                ...
                attrs: {
                    rel: "stylesheet",
                    href: "/res/styles/custom/projects/rgdigital/global.css"
                }
            }
        },
        {
        ...
        {
            name: "crosspageBootstrap",
            opt: {
                contents: [
                    { data: "<script src=\"//netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js\"></script>" }
                ]
            }
        },
		{
        ...
        },
		{
            ...
            opt: {
                contents: [
                    { data: "<script src=\"/res/scripts/custom/projects/rgdigital/lib.js\"></script>" }
                ]
            }
        },
		{
            ...
            opt: {
                contents: [
                    { data: "<script src=\"/res/scripts/custom/projects/rgdigital/script.js\"></script>" }
                ]
            }
        },
		{
            ...
            opt: {
                contents: [
                    { data: "<script src=\"/res/scripts/custom/projects/rgdigital/script_article.js\"></script>" }
                ]
            }
        },
		{
        ...
        },
		{
            ...
            opt: {
                contents: [
                    { data: "<script type=\"text/javascript\">var project_url = '//digital.rg.ru';var project_id_str = 'digital';</script>" }
                ]
            }
        },
    ]
