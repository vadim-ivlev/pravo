	...
	*/
	...
	function initBanner(bannerPlaceId,requestSrc) {
		var 
			...
			iframeHtml = '<div styles="visibility:hidden; position:absolute;"><iframe id="AdFox_iframe_'+pr1+'" width=1 height=1 marginwidth=0 marginheight=0 scrolling=no frameborder=0></iframe></div>',
