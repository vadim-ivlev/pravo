    ...
    toMerge: {
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.main:rules') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:rules', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:rules', '#sidebar')
