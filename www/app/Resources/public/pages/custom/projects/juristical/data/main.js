	...
	toMerge: {
		...
		main: {
		    ...
		    blocks: [
				...
				RGB('projects.juristical.header:index'), // шапка сайта
				
				RGB('projects.juristical.main:index') // основной контент
		...
		sidebarLeft: {
	 		...
	 		blocks: [
				...
				RGB('projects.juristical.sidebar-left:index', '#sidebar')
		...
		sidebarRight: {
    		...
    		blocks: [
				...
				RGB('projects.juristical.sidebar-right:index', '#sidebar')
