    ...
    toMerge: {
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.header:partners'), // шапка сайта

                RGB('projects.juristical.main:partners') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:partners', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:partners', '#sidebar')
