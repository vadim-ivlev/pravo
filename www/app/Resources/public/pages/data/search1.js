    ...
    toMerge: {
            ...
            blocks: [
                 ...
                 */
                {
                    ...
                    opt: {
                        ...
                        attrs: {
                            property: "og:title",
                            content: "Рубрики и актуальные теги — Юридическая консультация"
                        }
                    }
                },
                /*{
                ...
                },*/
                {
                    ...
                    opt: {
                        ...
                        contents: [
                            {
                                data: "Рубрики и актуальные теги — Юридическая консультация"
                            }
                        ]
                    }
                },
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('sidebar-left:rubrics', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('sidebar-right:rubrics', '#sidebar')
