...
var GalleryBuilder = function(option_id, gallery_id, custom_settings) {
	...
	this._meta = {
		...
		data_url: 'http://foto.rg.ru/project/photos/insert.php?option_id=' + option_id + '&photorep_id=' + gallery_id + '&callback=?'
	};
...
GalleryBuilder.prototype.setPathToImage = function() {
	...
	var host = 'http://cdnimg.rg.ru/i/gallery/',
...
GalleryBuilder.prototype.getLinkedMaterials = function(mainTmpl) {
	...
	var linked_materials = [],
		...
		root_path = 'http://' + location.host + '/include/';
...
GalleryBuilder.prototype.initAdvAdFox = function() {
	...
	this.getAdvAdFoxUnit('adsB_240_1', 'http://ads.adfox.ru/5906/prepareCode?p1=sie&amp;p2=cqs&amp;pct=a&amp;pfc=a&amp;pfb=a')
		.getAdvAdFoxUnit('adsB_tgb_1', 'http://ads.adfox.ru/5906/prepareCode?p1=biwbq&amp;p2=csz&amp;pct=a&amp;pfc=a&amp;pfb=a')
		.getAdvAdFoxUnit('adsB_tgb_2', 'http://ads.adfox.ru/5906/prepareCode?p1=bjipi&amp;p2=csz&amp;pct=a&amp;pfc=a&amp;pfb=a')
		.getAdvAdFoxUnit('adsB_500_1', 'http://ads.adfox.ru/5906/prepareCode?p1=bkiij&amp;p2=esud&amp;pct=a&amp;pfc=a&amp;pfb=a');
...
GalleryBuilder.prototype.sendStat = function() {
	...
	var url_gall = 'http://foto.rg.ru/photos/' + this._meta.gallery_id + '/index.html',
...
//http://foto.rg.ru/project/photos/add_ref.php?url='//rg.ru/ARTICLE_HREF'&photorep_id='ID'&aticle_id='ID'
	...
	var gallery_id = this._meta.gallery_id,
		...
		article_id = $('#comments_hidden').attr('oid'),
		refferers = (!!this._gallData) ? this._gallData.referers : [],
		link_path = 'http://foto.rg.ru/project/photos/add_ref.php',
		link_url = '?url=http://' + location.host + location.pathname,
