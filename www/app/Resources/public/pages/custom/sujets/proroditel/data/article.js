	...
	toMerge: {
		...
		head: {
			blocks: [
				...
				//RGB('builder:sujet'), // builder

				//RGInclude('sujet', 'styles'), // стили

				RGInclude('material', 'styles'), // стили

				RGInclude('custom/sujets/proroditel/index', 'styles'),
		...
		main: {
			...
			blocks: [
				...
				RGB('sujets.proroditel.header:sujets'),

				RGB('sujets.proroditel.branding-head:sujets'), // брендированный баннер

				//RGB('sujets.proroditel.list-head:sujets'), // заголовок страницы
