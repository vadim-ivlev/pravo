    ...
    toMerge: {
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.main:rubrics') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:rubrics', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:rubrics', '#sidebar')
