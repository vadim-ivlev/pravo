	...
	toMerge: {
		...
		head: {
			blocks: [
				...
				RGInclude('custom/projects/forumspb2016/index', 'styles'),

				RGInclude('material', 'scripts'),

				RGInclude('custom/projects/forumspb2016/index', 'scripts')
...

				{
					...
					opt: {
						...
						blocks: [
							...
							RGB('projects.forumspb2016.ads:under-materials'), // баннер
		...
		sidebarRight: {
			...
			blocks: [
				RGB('projects.forumspb2016.sidebar-right:article')
			]
