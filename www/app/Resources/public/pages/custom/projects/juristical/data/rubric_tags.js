    ...
    toMerge: {
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.header:rubric_tags'), // шапка сайта

                RGB('projects.juristical.main:rubric_tags') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:rubric_tags', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:rubric_tags', '#sidebar')
