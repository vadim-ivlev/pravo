 ...
 */
class AuthUsersRepository extends \Doctrine\ORM\EntityRepository
    implements createSitemapRepositoryInterface, SearchEntityInterface
{
...
//                }
    ...
    public function getSearchResult(array $idSearch, $limit, $offset) : array
    {
        $sql = "
            ...
            WHERE au.id IN (?) AND au.disabled = ? AND au.is_jurist = ?
            GROUP BY au.id
            ORDER BY au.name
            LIMIT ?
            OFFSET ?
