    ...
    toMerge: {
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.main:rubric_questions') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:rubric_questions', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:rubric_questions', '#sidebar')
