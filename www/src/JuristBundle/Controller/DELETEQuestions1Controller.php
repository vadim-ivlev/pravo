...
{
    public function formedDataAction($id = 1, $limitPagination/*, $aliasEntity = 'q'*/){
        ...
        if ($redisNow) {
            ...
            $Questions = $this->connect_to_Jurists_bd->getRepository('JuristBundle:Questions')->fetchQuestions($limitPagination, self::COUNT_RECORDS_ON_PAGE_JURISTS);
