			...
			contents: [
				{
					param: {
						...
						blocks: {
							...
							categoriesSidebar: RGB('projects.juristical.categories:sidebar, tablet tabletLandscape desktop desktopFull:active'), // меню рубрик в сайдбаре

							adsSidebarRight: RGB('projects.juristical.ads:sidebar-right, tablet tabletLandscape'), // рекламный баннер
							...
							questionsLatest: RGB('projects.juristical.questions:latest', '#questions_latest__length'), // Последние вопросы

							yandexDirect: RGB('projects.juristical.yadirect:sidebar-left'), // Яндекс-директ

							juristsFeed: RGB('projects.juristical.jurists:feed'), // лента юристов, предлагающих услуги (в сайдбаре)

							juristsTop: RGB('projects.juristical.jurists:top') // список лучших юристов (в сайдбаре)
