    ...
    toMerge: {
        ...
        head: {
            ...
            blocks: [
                ...
                RGInclude('https://rg.ru/custom/projects/juristical/global', 'styles'), // стили

                RGInclude('https://rg.ru/custom/projects/juristical/global', 'scripts'), // скрипты
        ...
        main: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.header:ask'), // шапка сайта

                RGB('projects.juristical.main:ask') // основной контент
        ...
        sidebarLeft: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-left:ask', '#sidebar')
        ...
        sidebarRight: {
            ...
            blocks: [
                ...
                RGB('projects.juristical.sidebar-right:ask', '#sidebar')
